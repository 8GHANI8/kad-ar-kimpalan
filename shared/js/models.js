...
registerGLBModel("shield", "assets/models/helmet-welding.glb", 1);
registerGLBModel("glove", "assets/models/glove.glb", 1);
registerGLBModel("shoe", "assets/models/kasut-keselamatan.glb", 1);
registerGLBModel("apron", "assets/models/ppe.glb", 1);
registerGLBModel("sudut_ok", "assets/models/1F-pos.glb", 1);
registerGLBModel("sudut_no", "assets/models/sudut-ko-anim.glb", 1);
registerGLBModel("speed_L", "assets/models/speed-laju-anim.glb", 1);
registerGLBModel("speed_s", "assets/models/speed-slow-anim.glb", 1);
registerGLBModel("speed_ok", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("arus-L", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("arus-H", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("arus-ok", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("jarak-h", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("jarak-L", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("jarak-ok", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("pos-ko", "assets/models/speed-ok-anim.glb", 1);
//registerGLBModel("pos-ok", "assets/models/speed-ok-anim.glb", 1);
registerGLBModel("wirebrush", "assets/models/wire-brush.glb", 1);
//registerGLBModel("grinder", "assets/models/speed-ok-anim.glb", 1);
registerGLBModel("plyer", "assets/models/pliers.glb", 1);
registerGLBModel("chip", "assets/models/chiping-hammer.glb", 1);
registerGLBModel("file", "assets/models/file.glb", 1);
registerGLBModel("tukul", "assets/models/tukul.glb", 1);
registerGLBModel("pahat", "assets/models/pahat.glb", 1);
